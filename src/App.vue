  ...
  <div class="min-h-screen bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500">
    ...
    <main class="p-3 md:p-4 lg:p-6">
      <div class="flex flex-col lg:flex-row gap-4 lg:gap-6">
        ...
        <!-- Left Column: The Wheel - Full width -->
        <div class="w-full lg:flex-1 bg-white rounded-2xl md:rounded-3xl shadow-2xl p-4 md:p-6 flex flex-col">
          
          <!-- Canvas Container -->
          <div class="relative flex-1 flex items-center justify-center min-h-0 py-2">
            <div class="relative w-full max-w-[550px] mx-auto" ref="canvasContainer">
              <canvas
                ref="wheelCanvas"
                :width="canvasSize"
                :height="canvasSize"
              ...
              <div class="absolute -top-1 left-1/2 -translate-x-1/2">
                <div class="w-0 h-0 border-l-[20px] sm:border-l-[24px] md:border-l-[28px] border-l-transparent border-r-[20px] sm:border-r-[24px] md:border-r-[28px] border-r-transparent border-t-[28px] sm:border-t-[34px] md:border-t-[40px] border-t-red-500 drop-shadow-lg"></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="w-full lg:w-[320px] xl:w-[360px] bg-white rounded-2xl md:rounded-3xl shadow-2xl p-4 md:p-5 flex flex-col">
          ...
          <!-- Add Name Form -->
          <form @submit.prevent="addName" class="mb-3 md:mb-4">
          ...
          <div v-if="showBulkImport" class="mb-3">
            ...
            <button
              ...
              class="mt-2 w-full py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg text-sm font-medium transition-colors flex items-center justify-center gap-1.5"
            >
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div class="flex-1 overflow-y-auto min-h-0 max-h-[400px] lg:max-h-none">
            <div v-if="names.length === 0" class="text-center py-8 text-gray-400">
              <svg class="w-10 h-10 mx-auto mb-2 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path>
              </svg>
              <p class="text-sm">No names yet</p>
              <p class="text-xs text-gray-400 mt-1">Add names to get started</p>
            </div>
            ...
            <div v-else class="space-y-2">
              ...
              >
                ...
                <button
                  ...
                  :disabled="isSpinning"
                  class="opacity-0 group-hover:opacity-100 transition-opacity text-red-500 hover:text-red-700 p-1 rounded-full hover:bg-red-50"
                >
                  <svg class="w-4 h-4 md:w-5 md:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <Teleport to="body">
      <Transition name="modal">
        ...
        >
          ...
          <div class="relative bg-white rounded-2xl md:rounded-3xl shadow-2xl max-w-[90%] md:max-w-md w-full p-6 md:p-8 transform transition-all">
            <div class="absolute -top-5 left-1/2 -translate-x-1/2">
              <div class="w-14 h-14 md:w-16 md:h-16 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-full flex items-center justify-center shadow-lg">
            ...
            <div class="text-center mt-3">
              ...
              <p class="text-base md:text-lg text-gray-600 mb-5 md:mb-6 flex items-center justify-center gap-2">
              ...
              <div class="flex gap-3">
                ...
                <button
                  @click="closeModal"
                  class="flex-1 py-2.5 md:py-3 px-4 bg-gray-200 hover:bg-gray-300 text-gray-700 font-bold rounded-xl transition-all text-sm md:text-base"
                >
                  Close
                </button>
              </div>
              ...
              <button
                ...
                class="mt-3 text-sm text-red-500 hover:text-red-700 transition-colors flex items-center justify-center gap-1.5 mx-auto"
              >
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path>
                </svg>
    ...
    <Teleport to="body">
      <Transition name="modal">
        ...
        >
          ...
          <div class="relative bg-white rounded-2xl shadow-2xl max-w-[90%] md:max-w-sm w-full p-6">
...
const updateCanvasSize = () => {
  ...
  const size = Math.min(550, Math.max(350, Math.min(containerWidth, containerHeight)))
...
const drawWheel = () => {
  ...
  const radius = Math.min(centerX, centerY) - Math.max(25, canvas.width * 0.04)
